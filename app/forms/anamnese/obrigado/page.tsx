...
export const metadata: Metadata = {
  ...
  description: "Obrigada por preencher a anamnese da orientação parental.",
...
export default function FormularioAnamneseObrigadoPage() {
  return (
        ...
        <Container className="relative z-10 flex min-h-[70vh] flex-col items-center justify-center py-20 text-center md:min-h-[80vh]">
          ...
          <RevealOnScroll delay={280}>
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-[var(--color-va-silver)] md:text-xl">
              Já recebi tudo por aqui. Vou ler cada resposta com cuidado para
              preparar o nosso primeiro encontro com a atenção que a sua família
              merece. Em breve a Valquiria entra em contato.
            </p>
          </RevealOnScroll>
