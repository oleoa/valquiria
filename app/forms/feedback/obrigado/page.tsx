...
export const metadata: Metadata = {
  title: "Feedback recebido — Valquiria Abreu",
  description: "Obrigada por compartilhar o seu feedback sobre a jornada.",
...
export default function FormularioFeedbackObrigadoPage() {
  return (
        ...
        <Container className="relative z-10 flex min-h-[70vh] flex-col items-center justify-center py-20 text-center md:min-h-[80vh]">
          ...
          <RevealOnScroll delay={280}>
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-[var(--color-va-silver)] md:text-xl">
              Cada palavra sua é lida com carinho. Até a próxima.
            </p>
          </RevealOnScroll>
