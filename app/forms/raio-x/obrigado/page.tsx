...
export const metadata: Metadata = {
  ...
  description: "Obrigada por preencher o Questionário Raio X.",
...
export default function FormularioRaioXObrigadoPage() {
  return (
        ...
        <Container className="relative z-10 flex min-h-[70vh] flex-col items-center justify-center py-20 text-center md:min-h-[80vh]">
          ...
          <RevealOnScroll delay={280}>
            <p className="mt-8 max-w-2xl text-base leading-relaxed text-[var(--color-va-silver)] md:text-xl">
              Já recebi o seu raio X por aqui. Vou ler com cuidado cada resposta e,
              em breve, a Valquiria entra em contato. Até lá, fica o convite para
              respirar e seguir com leveza.
            </p>
          </RevealOnScroll>
