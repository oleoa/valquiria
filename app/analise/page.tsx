        ...
        <Container>
          ...
          <RevealOnScroll>
            <div className="mx-auto mt-6 max-w-2xl">
              <div className="relative overflow-hidden rounded-3xl border border-[var(--color-va-blue)]/40 bg-[var(--color-va-bg)] p-10 shadow-[0_40px_100px_-40px_rgba(56,96,130,0.5)] md:p-14">
